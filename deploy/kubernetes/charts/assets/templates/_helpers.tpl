...
*/}}
{{- define "assets.name" -}}
{{- default "assets" .Values.nameOverride | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- else }}
{{- $name := default "assets" .Values.nameOverride }}
...
*/}}
{{- define "assets.chart" -}}
{{- printf "%s-%s" "assets" .Chart.Version | replace "+" "_" | trunc 63 | trimSuffix "-" }}
{{- end }}
