...
# - OIDC provider (shared with IRSA for other services)
# - IAM policy + role bound to the controller's service account
# - Public subnet tags for internet-facing ALB discovery
# - Helm release
####################################################################

data "tls_certificate" "eks_oidc" {
  url = aws_eks_cluster.retail_store.identity[0].oidc[0].issuer
}
...
# Tag public subnets so the controller can discover them for internet-facing ALBs
