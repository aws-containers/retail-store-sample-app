...
require (
	...
	github.com/signalfx/splunk-otel-go/instrumentation/database/sql/splunksql v1.7.0 // indirect
...
require (
	...
	github.com/signalfx/splunk-otel-go/instrumentation/github.com/jmoiron/sqlx/splunksqlx v1.7.0
