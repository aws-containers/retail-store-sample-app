...
public class SizeRequestBuilder extends BaseRequestBuilder {
     ...
     */
    public SizeRequestBuilder(@jakarta.annotation.Nonnull final HashMap<String, Object> pathParameters, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public SizeRequestBuilder(@jakarta.annotation.Nonnull final String rawUrl, @jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
     ...
     */
    @jakarta.annotation.Nullable
    public CatalogSizeResponse get(@jakarta.annotation.Nullable final java.util.function.Consumer<GetRequestConfiguration> requestConfiguration) {
        ...
        return this.requestAdapter.send(requestInfo, errorMapping, CatalogSizeResponse::createFromDiscriminatorValue);
    }
    /**
     * Get catalog size
     ...
     */
    @jakarta.annotation.Nonnull
    public SizeRequestBuilder withUrl(@jakarta.annotation.Nonnull final String rawUrl) {
