...
public class CatalogClient extends BaseRequestBuilder {
    /**
    ...
    /**
     * Instantiates a new {@link CatalogClient} and sets the default values.
     * @param requestAdapter The request adapter to use to execute the requests.
     */
    public CatalogClient(@jakarta.annotation.Nonnull final RequestAdapter requestAdapter) {
